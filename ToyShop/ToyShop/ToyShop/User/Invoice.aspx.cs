    ...
    public partial class Invoice : System.Web.UI.Page
    {
        ...
        protected void lbDownloadInvoice_Click(object sender, EventArgs e)
        {
            try {
                ...
                string dowloadPath = @"E:\Order_Invoice.Pdf";
                DataTable dtbl = GetOrderDetails();
                ExportToPdf(dtbl, dowloadPath, "Order Invoice");

                WebClient client = new WebClient();
                Byte[] buffer = client.DownloadData(dowloadPath);
                if (buffer != null) 
                {
        ...
        void ExportToPdf(DataTable dtblTable, String strPdfPath, string strHeader)
        {
            ...
            prgAuthor.Add(new Chunk("Order From : Online ToyShop System", fntAuthor));
