<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="ToyShop.User.Registration" %>
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:TextBox ID="txtName" runat="server" CssClass="form-control" placeholder="Enter FullName"
                        ...
                        <div>
                            ...
                            <asp:RegularExpressionValidator ID="revMobile" runat="server" ErrorMessage="Mobile Number Must be have 10 Digits!!"
                ...
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div>
                            ...
                            <asp:RegularExpressionValidator ID="revPassword" runat="server" ErrorMessage="Password must contain at least 6 characters including 1 letter, 1 digit, and 1 special character"
                                ControlToValidate="txtPassword" ValidationExpression="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{6,}$"
