<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Contacts.aspx.cs" Inherits="ToyShop.Admin.Contacts" %>
                                                          ...
                                                          <tr>
                                                              ...
                                                              <td>
                                                                  <asp:LinkButton ID="lnkDelete" Text="Delete" runat="server" CommandName="delete"
                                                                      ...
                                                                      OnClientClick="return confirm('Do You Want to Delete This Recored?');">
                                                                      <i class="ti-trash"></i>
                                                                  </asp:LinkButton>
                                                              </td>
                                                          </tr>
