<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="ToyShop.Admin.Dashboard" %>
                ...
                <div class="page-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xl-3">
                            ...
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                   <i class="icofont icofont-airplane bg-c-blue card1-icon"></i>
                                    <span class="text-c-orenge f-w-600">Total Orders</span>
                            ...
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                   <i class="icofont icofont-fast-delivery bg-c-yellow card1-icon"></i>
                                    <span class="text-c-yellow f-w-600">Delivered Toys</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xl-3">
                            ...
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                   <i class="icofont icofont-money-bag bg-amazon card1-icon"></i>
                                    <span class="text-c-orenge f-w-600">Sold Ammount</span>
                                    <h4><% Response.Write(Session["soldAmmount"]); %></h4>
                                    <div>
                                        <span class="f-left m-t-10 text-muted">
                            ...
                            <div class="card widget-card-1">
                                <div class="card-block-small">
                                   <i class="icofont icofont-support-faq bg-c-green card1-icon"></i>
